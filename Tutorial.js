...
var DefibSession = { Id: -1, UserId: "", SessionDate: "" };
var TestCase1 = { Casenum: 1, SessionId: -1, UserID: "d", FirstTimeUser: true, SessionDate: 50, TimeToStartCPR: -1, TimeToTurnDefibOn: -1, TimeToPadsAttached: -1, ShocKWithEnergyGreaterThan59: false, AnalyzePressed: false, ShockInAnalyze: false, ClickedStartCPRAfterShock: false, SurvivalStateReached: false, DeathStateReached: false, TotalCaseTime: 0, CaseTimeMoreThanFourMin: false, CaseTimeLessThan2Min: false, TotalPoints: 0 };
...
var TestCase2 = { Casenum: 2, UserID: "d", FirstTimeUser: true, SessionDate: 50, VFibStateEntered: false, TimeToStartCPRAfterVFib: 0, TimeToTurnDefibOn: -1, TimeToPadsAttached: -1, ShockWithEnergyGreaterThan84: false, VFibStartTime: 0, ShockWithoutSync: false, AnalyzePressed: false, ShockInAnalyze: false, StartedCPRAfterVFibShock: false, SurvivalStateReached: false, DeathStateReached: false, TotalCaseTime: 0, CaseTimeMoreThanFourMin: false, CaseTimeLessThan2Min: false, TotalPoints: 0 };
...
$(function () {
	...
	$("#IntroModal").dialog( {
		...
		$(".tutorial").hover(function() {
			...
			switch($(this).attr('id')) {
				case "OnOff":
				var tutStatement = "ON button:  Turns machine power ON or OFF. Turning the machine ON is the first step in performing any function with the Lifepak defibrillator."
				var tutTitle = "On"
				break;
				case "EnergySelectLeft":
				var tutStatement = "This control allows the user to select the desired energy dose by pushing the up or down arrows."
				var tutTitle = "Energy Select"
				break;
				...
				break;
				case "Charge":
				var tutStatement = "Pressing the CHARGE button charges the machine to the selected energy dose. You must press CHARGE first before delivering a shock."
				var tutTitle = "Charge"
				var tutStatement2 = "You can interrupt the charging process by pressing the Speed Dial button right here. -->"
				isChargeDialogOn = true;
				break;
				case "ShockButton":
				var tutStatement = "The SHOCK button discharges the selected energy dose to the patient."
				var tutTitle = "Shock"
				break;
				case "AnalyzeButton":
				...
				var tutTitle = "Analyze"
				var top = 70;
				var left = 150;

				break;
				case "Pacer":
				var tutStatement = "Pressing the PACER button engages the machine's pacing functions.<i>The Lifepak's own ECG leads must be attached to the patient in order to perform demand pacing.</i>"
				var tutTitle = "Pacer"
				break;
				...
				break;
				case "RateLeft":
				var tutStatement = "Once the PACER button is engaged, press the up or down arrows to select the (paced) heart rate you wish the patient to have."
				var tutTitle = "Rate"
				break;
				case "RateRight":
				var tutStatement = "Once the PACER button is engaged, press the up or down arrows to select the (paced) heart rate you wish the patient to have."
				...
				break;
				case "CurrentLeft":
				var tutStatement = "Once the PACER button is engaged and the desired RATE is selected, press the up or down arrows to adjust the pacing current until each vertical pacing spike is followed by a wide QRS complex."
				var tutTitle = "Current"
				break;
				case "CurrentRight":
				var tutStatement = "Once the PACER button is engaged and the desired RATE is selected, press the up or down arrows to adjust the pacing current until each vertical pacing spike is followed by a wide QRS complex. "
				var tutTitle = "Current"
				...
				var tutTitle = "Speed Dial"
				break;
				case "LeftPad":
				var tutStatement = "Multifunction electrodes that allow the defibrillator to deliver an electrical stimulus to the patient. Attaching the Quik-Combo pads is a multistep process. <a style='color:blue; cursor: pointer; text-decoration:underline' onclick='showMeHow2()'>Show Me How</a>"
				var tutTitle = "Quik-Combo Pad"
				break;
				case "RightPad":
				var tutStatement = "Multifunction electrodes that allow the defibrillator to deliver an electrical stimulus to the patient. Attaching the Quik-Combo pads is a multistep process <a style='color:blue; cursor: pointer; text-decoration:underline' onclick='showMeHow2()'>Show Me How</a>"
				var tutTitle = "Quik-Combo Pad"
				break;
				case "TestPlug":
				var tutStatement = "When the defibrillator is not in use, the test plug is typically attached to the therapy cable, and must be removed in order to connect Quick-Combo pads to the therapy cable. Use your mouse to drag the test plug away from the therapy cable."
				var tutTitle = "Test Plug"
				break;
				case "LLEKG":
				case "LAEKG":
				case "RAEKG":
					var tutStatement = "To attach the the Lifepak's ECG leads, drag and drop each individual lead to the designated location marker on the body. <a style='color:blue; cursor: pointer; text-decoration:underline' onclick='showMeHow()'>Show me how</a>"
					var tutTitle = "Lifepak ECG Lead"
					break;
				case "GrayCable":
				case "TherapyCable":
				var tutStatement = "The therapy cable must be connected to its attachment port in order for the pads to work. You can use your mouse to attach the therapy cable to the Quik-Combo pads once you drag off the black test plug."
				var tutTitle = "Therapy Cable"
				break;
				case "EKGConnector":
				var tutStatement = "Lifepak's own ECG leads connect to the defibrillator when the ECG cable is plugged in to the ECG cable port. Use your mouse to drag and drop the end of the cable onto the ECG port."
				var tutTitle = "ECG Cable"
				break;
				case "EKGPort":
				var tutStatement = "To connect the Lifepak's own ECG leads, drag the ECG cable to the green ECG Cable Port and drag the individual leads to the patient."
				var tutTitle = "ECG Port"
				break;
				case "TherapyPort":
				var tutStatement = " Site of attachment for EITHER the therapy cable or the machine's hard paddles."
				var tutTitle = "Therapy Cable Attachment Port"
				break;
				case "PrintButton":
				var tutTitle = "Print Button"
				var tutStatement = "This feature is not essential for defibrillator operation and will not be covered in this module"
				break;
				case "EventButton":
				var tutTitle = "Event Button"
				var tutStatement = "This feature is not essential for defibrillator operation and will not be covered in this module"
				break;
				case "CodeSummary":
				var tutTitle = "Code Summary"
				var tutStatement = "This feature is not essential for defibrillator operation and will not be covered in this module"
				break;
				case "SizeButton":
				var tutTitle = "Size Button"
				var tutStatement = "This feature is not essential for defibrillator operation and will not be covered in this module"
				break;
				case "Alarms":
				var tutTitle = "Alarms"
				...
				break;
				case "Options":
				var tutTitle = "Options"
				var tutStatement = "This feature is not essential for defibrillator operation and will not be covered in this module"
				break;
				case "HomeScreen":
				var tutTitle = "Home Screen"
				var tutStatement = "This feature is not essential for defibrillator operation and will not be covered in this module"
				break;
				case "Help":
				var tutTitle = "Help"
				var tutStatement = "Clicking the HELP button will tell you what to do next during the Tutorial Cases. HELP will not be available during the Test Cases."
				break;
	...
	$("#ShockButton").mousedown(function() {
			...
			if (patientState=="Sync"&&chargeJoules<=20&&!isTestOn&&isShockReady){
				...
				setTimeout(function() {othershockbool = true;},1000)
				setTimeout(function() {
					document.getElementById('EnergyDelivered').style.display = "none"; 
	...
	$("#Assess").click(function(e) {
		...
		if (patientState=="GoodWithPace"&&!isTestOn) {
			...
			$('#PatientStatus').dialog({title:"Congratulations!",autoOpen:true, modal:true});
		...
		// 	helpController(12);
		// 	patientState="NormalCPR"
			
		// }
		// if (patientState=="NormalCPR") {


		// 	document.getElementById("EndDialog").innerHTML = "The patient has a pulse! He is in sinus rhythm. You have saved the patient! <a href='Tutorial.html?testnum=2' >Click here to move on to the next case</a>.<br> Alternatively, <a href='Tutorial.html?testnum=1'>Click here to repeat the case</a>"
		// 	$('#EndDialog').dialog({"width":400,
		// 		modal:true,
		// 		autoOpen:true});
		// }
	...
	// 		document.getElementById('OnOff').src = "assets/LifePakOnO_active.png"
	// 	});
	...
	$( "#RightPad" ).draggable({ 
		...
		stop: function( event, ui ) {
    		...
    		// var ltargx = parseInt(document.getElementById("LeftPad").style.left)
    		// var ltargy =  parseInt(document.getElementById("LeftPad").style.top)


    		if (Math.abs(rpx-rtargx) < 20 && (Math.abs(rpy-rtargy)) < 20) {
    // 			document.getElementById("ChangeRhythm").style.display = "none"
				// document.getElementById("CurrentRhythm").style.display = "none"
				isRightPadConnected = true
...
jsPlumb.ready(function() {
	...
	instance.doWhileSuspended(function() {
		...
		var e1 = instance.addEndpoint('RightPad', { anchor:"Bottom" }, exampleEndpoint);
		var e2 = instance.addEndpoint('TherapyCable', { anchor:[1, .61, 0, -1]}, exampleEndpoint);
		var e3 = instance.addEndpoint('LeftPad', { anchor:"Bottom" }, exampleEndpoint);
		var e4 = instance.addEndpoint('GrayCable', { anchor:"Left" }, exampleEndpoint);
		var e41 = instance.addEndpoint('GrayCable', { anchor:"Right" }, exampleEndpoint);
		var e5 = instance.addEndpoint('WhiteCable', { anchor:"Right" }, exampleEndpoint);

		var e6 = instance.addEndpoint('LLEKG', { anchor:"Bottom" }, exampleEndpoint);
		var e7 = instance.addEndpoint('LAEKG', { anchor:"Bottom" }, exampleEndpoint);
		var e8 = instance.addEndpoint('RAEKG', { anchor:"Bottom" }, exampleEndpoint);
		var e9 = instance.addEndpoint('FloatingEKG', { anchor:"Left" }, exampleEndpoint);
		var conn1 = instance.connect({source:e1, target:e5});
		var conn2 = instance.connect({source:e3, target:e5});
		...
		stop: function( event, ui ) {  
			...
			if (Math.abs(lpx - tpx) < 15 && (Math.abs(lpy - tpy)) < 15) {
				...
				if ((Math.abs(lpx - wpx) < 50 && (Math.abs(lpy - wpy)) < 30)&&isLeftPadConnected&&isRightPadConnected&&!isTestPlugAttached) {
					...
					instance.connect({source:e1, target:e41});
					instance.connect({source:e3, target:e41});
...
function caseSelection(caseNum) {
	...
	if (caseNum == 0) {
		...
		// document.getElementById('LeftPadTarget').style.display = "none"
		// document.getElementById('RightPadTarg').style.display = "none"
...
function heartBeatTick() {
	...
	setTimeout(function() {document.getElementById('Heart').style.display = "block"}, 100)
};
...
function moveTicker() {
	...
	if (initp < 482) {
		...
		// document.getElementById("CurrentRhythm").style.left = initp+10+"px";
...
document.getElementById('MainScreen').style.background = "url('assets/StartupScreen.png')";
		...
		return;
	// 		if (isPacerOn&&((isLAEKGConnected&&isLLEKGConnected&&RAEKGTarget) || leadStatus =="Paddles"))
	...
	// document.getElementById("ConnectElectrodes").style.display = "none"
	// document.getElementById("BottomBar").style.display ="none";
	// document.getElementById("RhythmChange").style.display = "none"
	// clearInterval(TickVar);
	// clearInterval(document.syncInterval);
	// clearTimeout(document.turnStartScreenOff);
	// on = false
	// isOnLoading = false;
	// isPacerOn = false;
	// ispacerFuncOn = false
	// rhythmChange(initp,"black url('assets/Flatline.png')");
	// document.getElementById('OnOff').src= "assets/LifePakOnOff.png";
	// document.getElementById('MainScreen').style.background = "black";
	// document.getElementById('TopMonitor').style.display = "none";
	}
}
}

turnEnergyOff = setTimeout(function() {document.getElementById('EnergyLevel').style.display = "none"; isEnergySelectionOn = false; }, 5000);
...
function energySelectUp() {
	...
	if (on&&(!isCharging)&&(!isShockReady)&&(isLeftPadConnected&&isRightPadConnected&&isElectrodesConnected&&isTherapyCableAttached)){
		...
		if (isEnergySelectionOn == false) {
			...
			turnEnergyOff = setTimeout(function() {document.getElementById('EnergyLevel').style.display = "none"; }, 5000);
			turnEnergyOff;
		}
		else {
			if(chargeJoules < 360) {
		...
		document.getElementById('BottomBar').style.display = "block";
		turnEnergyOff = setTimeout(function() {document.getElementById('EnergyLevel').style.display = "none"; isEnergySelectionOn = false; document.getElementById('RemoveTestPlug').style.display = "block"; document.getElementById('BottomBar').style.display = "none"}, 5000);
...
function speedDial() {
	if (on) {
		document.getElementById('LeadSelect').style.display = "none";isLeadSelectOn = false;
		if (isShockReady) {
			document.getElementById('ChargingBackground').style.display = "none"
			document.getElementById('ShockAdvised').style.display = "none"
			isShockReady = false
...
function pacer() {
	...
	if(on&&isLeftPadConnected&&isRightPadConnected&&isElectrodesConnected) {
		...
		if (!ispacerFuncOn) {
			...
			isPacerOn = true;
			leadNum = 3
			document.turnPacerOff = setTimeout(function() {document.getElementById('PacerMenu').style.display = "none";isPacerOn = false; document.getElementById("BottomPaceBar").style.display="block";} , 10000);
...
function currentLeft() {
	...
	if(on&&ispacerFuncOn) {
		...
		if(!isPacerOn) {
			...
			isPacerOn = true;
			document.getElementById("PacerMenu").style.display = "block";
			document.turnPacerOff = setTimeout(function() {document.getElementById("BottomPaceBar").style.display="block"; document.getElementById('PacerMenu').style.display = "none";isPacerOn = false;}, 10000);
		}
		else{
			...
			clearTimeout(document.turnPacerOff);
				...
				document.getElementById('HRNum').innerHTML = heartRate;}, 10000);
...
function currentRight() {
	...
	if(on&&ispacerFuncOn){
		...
		if(!isPacerOn) {
			...
			isPacerOn = true;
			document.getElementById("PacerMenu").style.display = "block";
			document.turnPacerOff = setTimeout(function() {document.getElementById('PacerMenu').style.display = "none";isPacerOn = false;}, 10000);
		}
		else{
			clearTimeout(document.turnPacerOff);
			document.turnPacerOff = setTimeout(function() {document.getElementById("BottomPaceBar").style.display="block"; document.getElementById('PacerMenu').style.display = "none";isPacerOn = false;}, 10000);
...
function leadSelect() {
	...
	if(on) {
		...
		if(!isLeadSelectOn) {
			...
			turnLeadSelectOff = setTimeout(function() {document.getElementById('LeadSelect').style.display = "none";isLeadSelectOn = false;}, 5000);
...
function CPRButton() {
	...
	if (!isCPROn) {
		...
		isCPROn = true;
		$('#CPRStatus').toggle()
		flashing = setInterval(function() {$('#CPRStatus').toggle()},400);
...
if (status!=null)
	// document.getElementById("HelpDialog").innerHTML = status
...
function errorController(errornum) {
	...
	$('#ErrorDialog').dialog({
		...
		$("#ErrorDialog").dialog({closeOnEscape:false,modal:true,dialogClass:"errorDialog"})
